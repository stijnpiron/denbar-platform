...
import { ServiceUnavailableException } from 'server/common/exceptions/service-unavailable.exception';
...
import { ServerErrorException } from 'server/common/exceptions/server-error.exception';
